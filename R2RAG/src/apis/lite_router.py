...
rag_systems: Dict[str, RAGInterface] = {
    ...
    # "vanilla-agent-lite": VanillaAgent(context_length=50_000,
    #                                    docs_review_max_tokens=10_000,
    #                                    answer_max_tokens=10_000,
    ...
    #                                alt_reranker_model=ALT_RERANKER_MODEL,
    #                                pre_flight_reranker=True),
    # "vanilla-ai-overview": VanillaRAG(skip_rerank=True,
    #                                   alt_llm_api_base=ALT_LLM_API_BASE_FAST_QWEN,
    #                                   alt_llm_api_key=ALT_LLM_API_KEY_FAST_QWEN,
    #                                   alt_llm_model=ALT_LLM_MODEL_FAST_QWEN,
    #                                   alt_reranker_api_base=ALT_RERANKER_API_BASE,
    ...
    "vanilla-rag-fast-gptoss": VanillaRAG(alt_llm_api_base=ALT_LLM_API_BASE_GPT_OSS,
                                          alt_llm_api_key=ALT_LLM_API_KEY_GPT_OSS,
                                          alt_llm_model=ALT_LLM_MODEL_GPT_OSS,
                                          alt_llm_reasoning_effort="low",
                                          alt_reranker_api_base=ALT_RERANKER_API_BASE,
                                          alt_reranker_api_key=ALT_RERANKER_API_KEY,
                                          alt_reranker_model=ALT_RERANKER_MODEL,
                                          pre_flight_reranker=True),
    "vanilla-ai-overview-gptoss": VanillaRAG(skip_rerank=True,
                                             alt_llm_api_base=ALT_LLM_API_BASE_GPT_OSS,
                                             alt_llm_api_key=ALT_LLM_API_KEY_GPT_OSS,
                                             alt_llm_model=ALT_LLM_MODEL_GPT_OSS,
                                             alt_llm_reasoning_effort="low"),
    ...
    #                                 alt_reranker_api_key=ALT_RERANKER_API_KEY,
    #                                 alt_reranker_model=ALT_RERANKER_MODEL,
    #                                 search_engine="brave_jina",
    #                                 pre_flight_reranker=False),
    # "brave-agent-lite": VanillaAgent(context_length=50_000,
    #                                  docs_review_max_tokens=10_000,
    #                                  answer_max_tokens=10_000,
    #                                  alt_llm_api_base=ALT_LLM_API_BASE_FAST_QWEN,
    #                                  alt_llm_api_key=ALT_LLM_API_KEY_FAST_QWEN,
    ...
    #                                  search_engine="brave_jina",
    #                                  pre_flight_reranker=True),
    "brave-ai-overview-gptoss": VanillaRAG(skip_rerank=True,
                                           alt_llm_api_base=ALT_LLM_API_BASE_GPT_OSS,
                                           alt_llm_api_key=ALT_LLM_API_KEY_GPT_OSS,
                                           alt_llm_model=ALT_LLM_MODEL_GPT_OSS,
                                           alt_llm_reasoning_effort="low",
                                           search_engine="brave_jina"),
    "brave-agent-lite-gptoss": VanillaAgent(context_length=50_000,
                                            docs_review_max_tokens=10_000,
                                            answer_max_tokens=10_000,
                                            alt_llm_api_base=ALT_LLM_API_BASE_GPT_OSS,
                                            alt_llm_api_key=ALT_LLM_API_KEY_GPT_OSS,
                                            ...
                                            search_engine="brave_jina",
                                            pre_flight_reranker=True),
    "brave-agent-claude": VanillaAgent(context_length=65536,
                                       docs_review_max_tokens=10_000,
                                       answer_max_tokens=10_000,
                                       alt_llm_reasoning_effort='low',
                                       alt_llm_api_base=ALT_LLM_API_BASE_SONNET_4,
    ...
    "brave-ctx-agent-lite": VanillaAgent(context_length=50_000,
                                         docs_review_max_tokens=10_000,
                                         answer_max_tokens=10_000,
                                         alt_llm_api_base=ALT_LLM_API_BASE_SONNET_4,
                                         alt_llm_api_key=ALT_LLM_API_KEY_SONNET_4,
